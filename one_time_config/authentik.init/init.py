...
def mk_proxy_app(name, slug, flow, **kwargs):
    ...
    edit_outpost(out['pk'], name='authentik Embedded Outpost', type='proxy', providers=out['providers'] + [prov['pk']], config=out['config'], service_connection=out['service_connection'], managed=out['managed'])
    return app
